function weightArray = AreaWeightAverage(fromAreaList, toAreaList, originalfromAreaList, originaltoAreaList, originalWeights)
    ...
    for n=1:N
        ...
        weightArray(n,:) = mean(originalWeights(bln,:), 1, 'omitnan');
    end
